      ...
      <div class="carousel-inner border-radius-lg h-100">
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Get started with Edu</h5>
            <p>
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Faster way to Accreditate your master degrees</h5>
            <p>
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Share with us your Plans!</h5>
            <p>
